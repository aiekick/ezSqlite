...
class DiagramEditorPane : public AbstractPane {
    IMPLEMENT_SHARED_SINGLETON(DiagramEditorPane)
    DISABLE_CONSTRUCTORS(DiagramEditorPane)
    DISABLE_DESTRUCTORS(DiagramEditorPane)
public:
    bool Init() override;
    void Unit() override;
