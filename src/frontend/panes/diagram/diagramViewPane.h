...
class DiagramViewPane : public AbstractPane {
    IMPLEMENT_SHARED_SINGLETON(DiagramViewPane)
    DISABLE_CONSTRUCTORS(DiagramViewPane)
    DISABLE_DESTRUCTORS(DiagramViewPane)
public:
    bool Init() override;
    void Unit() override;
